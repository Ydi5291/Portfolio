...
const PROJECTS_COPY = {
  de: {
    ...
    summarySecondary: 'Das Projekt wurde vollständig eigenständig konzipiert, entwickelt und produktiv veröffentlicht – von UI/UX über Backend-Logik bis hin zu Zahlungs- und Kommunikationssystemen.',
    ...
    integrationsItems: ['Payments: Stripe Connect', 'E-Mail: Brevo für Transaktionen und Notifications'],
    stackTitle: 'Stack',
  ...
  en: {
    ...
    summarySecondary: 'The project was fully designed, developed, and launched independently, from UI/UX and backend logic to payments and communication systems.',
    ...
    integrationsItems: ['Payments: Stripe Connect', 'Email: Brevo for transactions and notifications'],
    stackTitle: 'Stack',
    stackItems: ['Angular', 'TypeScript', 'SCSS', 'Firebase', 'REST APIs'],
